...
async function runAccessAlerts(env) {
  ...
  for (const orderId of pending.order_ids) {
    ...
    // sin first_tap_at, ej. migraciÃ³n manual admin o piezas "arriving"). Si ya
    // estÃ¡ activada, el cliente ya accediÃ³ â€” no hace falta alertar.
...
// â”€â”€ Bloque B parte 3B, Fase 6: cron purge retracts (cada hora) â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Bloque B parte 3B, Fase 9.1: POST /api/admin/access-alerts/resolve â”€â”€
// NOTA: action="issue_detected" segÃºn el encargo deberÃ­a "mover a Incidences",
// pero el sistema de Incidences (Fase 9.6.4) todavÃ­a no existe. Por ahora
// solo retira la alerta de access_alerts_active y lo deja logueado â€” la
// integraciÃ³n real con Incidences queda pendiente para cuando se construya.
...
async function handleAdminHealthSummary(request, env, url) {
  ...
  return new Response(JSON.stringify({
    ...
    worker: {
      version: "6.9.7-worker-restore-fix",
