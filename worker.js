...
// Extraída de /api/validate como helper reutilizable (Bloque B parte 2, sección 1).
// v6.6.4: rollback de la rotación Key0 (v6.6.3). Decisión consciente
// (Camino 3) tras análisis de modelo de amenaza — Key0 vuelve a zeros
// hardcoded, factory default. Ver README.md de potisse-ntag424 para el
// razonamiento completo. Camino 2a (rotación Key1) queda documentado
// como opción futura si aparece caso de uso concreto.
...
async function sendMagicLinkEmail(env, email, magicUrl) {
  ...
  if (!response.ok) {
    console.error(`[MAGIC LINK] Resend rejected: ${response.status} — ${bodyText}`);
...
// POTISSE Ã¢â‚¬â€ /api/customer-update endpoint
...
async function handleCustomerUpdate(request, env) {
  ...
  try {
    ...
    return jsonResponseYou({ ok: false, error: "Invalid request" }, 400);
  }
  ...
  if (!customer_id || !nonce || !signature || !first_name || !last_name || !email) {
    return jsonResponseYou({ ok: false, error: "Missing fields" }, 400);
  }

  const now = Math.floor(Date.now() / 1000);
  const nonceInt = parseInt(nonce, 10);
  if (!Number.isFinite(nonceInt) || Math.abs(now - nonceInt) > NONCE_WINDOW_SECONDS) {
    return jsonResponseYou({ ok: false, error: "Session expired. Refresh and try again." }, 401);
  }

  const payload = `${customer_id}.${nonce}`;
  let expectedSignature;
  try {
    expectedSignature = await hmacSha256HexYou(env.HMAC_SECRET_YOU, payload);
  } catch (err) {
    return jsonResponseYou({ ok: false, error: "Signature verification failed" }, 500);
  }

  if (!timingSafeEqualHex(signature, expectedSignature)) {
    return jsonResponseYou({ ok: false, error: "Invalid signature" }, 401);
  }
  ...
  if (!trimmedFirst || !trimmedLast) {
    return jsonResponseYou({ ok: false, error: "Required fields missing" }, 400);
  }

  if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(trimmedEmail)) {
    return jsonResponseYou({ ok: false, error: "Not a valid email" }, 400);
  }
  ...
  try {
    ...
    return jsonResponseYou({ ok: false, error: "Connection to Shopify failed" }, 502);
  }
  ...
  if (!shopifyRes.ok) {
    ...
    return jsonResponseYou({ ok: false, error: userMessage }, 400);
  }

  return jsonResponseYou({ ok: true });
}

async function hmacSha256HexYou(secret, message) {
...
function jsonResponseYou(data, status = 200) {
...
async function updateCustomerKvForSilencio1(env, order) {
  ...
  if (!rawCustomerId) {
    console.warn(`Silencio1: skipping order ${orderId} Ã¢â‚¬â€ no customer_id in payload (likely test webhook or guest checkout)`);
    return;
  }
  ...
  console.log(`Silencio1 step 1: variables extracted Ã¢â‚¬â€ customerId=${customerId} createdAt=${createdAt}`);

  // Detectar zona por country_code del shipping address.
  // Iberian: EspaÃƒÂ±a + Portugal peninsular.
  // Europe: resto de UE + Baleares (Baleares es ES pero se factura
  // como Europe segÃƒÂºn decisiÃƒÂ³n POTISSE).
...
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Helper: computar HMAC-SHA256 base64 de un string
...
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Helper: buscar index de una orden dentro del array
...
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Helper: calcular delivered_approx_at desde fulfilled_at
// segÃƒÂºn shipping_zone (iberian +3d, europe +7d, excluded/unknown null)
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
...
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Webhook orders/fulfilled handler
...
async function handleOrdersFulfilledForSilencio1(env, order) {
  ...
  if (!rawCustomerId) {
    console.warn(`Silencio1 fulfilled: skipping order ${orderId} Ã¢â‚¬â€ no customer_id`);
    return;
  }
  ...
  console.log(`Silencio1 fulfilled: updated order ${orderId} in customer ${customerId} Ã¢â‚¬â€ fulfilled_at=${fulfilledAt}, delivered_approx_at=${targetOrder.delivered_approx_at}`);
}
__name(handleOrdersFulfilledForSilencio1, "handleOrdersFulfilledForSilencio1");

// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Webhook refunds/create handler
...
async function handleRefundsCreateForSilencio1(env, refund) {
  ...
  if (!orderId) {
    console.warn(`Silencio1 refund: skipping refund ${refundId} Ã¢â‚¬â€ no order_id`);
    return;
  }
...
// Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
// SILENCIO 1 Ã¢â‚¬â€ Cron nightly evaluation
// Escanea TODOS los customers de KV y evalÃƒÂºa si cumplen criterios
// para pasar a is_candidate: true.
//
// Regla: Ã¢â€°Â¥2 orders con delivered_approx_at + 20 dÃƒÂ­as ya cumplidos,
...
async function evaluateSilencio1Candidates(env) {
  ...
  do {
    ...
    for (const keyEntry of list.keys) {
      ...
      // Filtrar orders vÃƒÂ¡lidas: delivered_approx_at existe, no refunded
      const validOrders = (obj.orders || []).filter(o =>
        o.delivered_approx_at && !o.refunded
      );

      // Necesita al menos 2 orders vÃƒÂ¡lidas
      if (validOrders.length < 2) continue;

      // La 2Ã‚Âª orden (por fecha de entrega) debe tener delivered_approx_at + 20d cumplido
      ...
      // Ã¢Å“â€œ Cumple criterios: marcar candidato
      ...
      console.log(`Silencio1 cron: new candidate Ã¢â‚¬â€ customer ${obj.id}`);
    }
...
// ── Bloque B parte 3B, Fase 6: cron Access alerts (08:00 UTC) ────────
async function runAccessAlerts(env) {
  ...
  for (const orderId of pending.order_ids) {
    ...
    // origin_date es la fuente de verdad de "pieza activada" (puede rellenarse
    // sin first_tap_at, ej. migración manual admin o piezas "arriving"). Si ya
    // está activada, el cliente ya accedió — no hace falta alertar.
    if (piece.origin_date) continue;
...
// ── Bloque B parte 3B, Fase 6: cron purge retracts (cada hora) ──────
async function runPurgeRetracts(env) {
  // v6.6.2: timestamp "el cron corrió" incondicional, primera línea —
  // antes quedaba detrás de los early returns de abajo y nunca se escribía
  // en producción (retracted_posts no existe todavía, pre-launch).
  ...
  for (const postId of index.pending || []) {
    ...
    if (!postRaw) continue; // ya purgado o borrado, se cae del índice
    ...
    if (post.status !== "retracted" || !post.retracted_at) continue; // ya no aplica, se cae del índice
...
// ════════════════════════════════════════════════════════════════
// BLOQUE B parte 1 — Piezas, washes, sesión Club (cookie potisse_session)
// ════════════════════════════════════════════════════════════════
...
// ── Bloque B parte 2: ¿el customer ya es miembro? (tiene alguna pieza tapeada) ──
...
// ── Pieces: creación al recibir orders/create ──────────────────────
...
async function createPiecesForOrder(env, order) {
  ...
  if (!customerId) {
    console.warn(`Pieces: skipping order ${orderId} — no customer_id`);
...
// ── Pieces: fulfillment_date + orders_pending_first_tap ─────────────
async function updatePiecesForFulfillment(env, order) {
  ...
  for (const pieceId of orderIndex.piece_ids) {
    ...
    if (piece.arriving === true) {
      ...
      // first_tap_at queda null a propósito: se rellenará cuando llegue
      // el tap real de la nueva tarjeta, como dato histórico.
    }
...
// ── Sesión Club: cookie potisse_session → session_<token> en KV ────
// NOTA: el endpoint que EMITE esta cookie (start-session) se construye
// en push 2, junto al handler NFC tap. Este bloque solo LEE la sesión.
...
// ── Bloque B parte 3A, sección 1.2: rate limit soft 100 req/min por customer_id ──
...
async function resolveClubSession(request, env) {
  ...
  // Rate limit ANTES del rolling refresh, per spec sección 1.2.
  const rl = checkClubRateLimit(session.customer_id);
  if (rl.limited) {
    return { error: "rate_limited", status: 429 };
  }

  // Bloque B parte 2, sección 6: refresh rolling — cada request autenticado
  // válido extiende la sesión 30min más, tanto en KV como (más abajo, en la
...
// ── In-memory cache /api/club/me (30 min, por customer_id) ─────────
...
// ── Bloque B parte 3A cierre: product_image por pieza, cacheado 24h en KV ──
// NOTA: el encargo original pedía env.SHOPIFY_ADMIN_TOKEN, un secret que no
// existe en producción (verificado con `wrangler secret list` — solo existe
...
async function getPieceProductImage(env, piece) {
  ...
  try {
    const shopifyDomain = env.SHOPIFY_STORE_DOMAIN || "potisse-shop.myshopify.com";
    const token = env.SHOPIFY_ACCESS_TOKEN;
    if (!token) {
...
// ── Fase 9.2, Corrección 2: cache 24h de tags Shopify para el listado ──
...
async function getCachedShopifyTags(env, customerId, fallbackEmail) {
  ...
  // Shopify falló de verdad (ok:false) — si hay cache vieja, mejor stale que null en la UI
  if (cached) return cached.tags;
  return "";
}
__name(getCachedShopifyTags, "getCachedShopifyTags");

// ── Bloque B parte 3B, Fase 5: anniversaries + journey + post_reply ──
...
// Placeholder fijo pendiente de fórmula real de Fran (ver reporte Fase 5).
...
async function handleClubMe(request, env) {
  ...
  // Paralelizado: cada pieza resuelve washes + product_image (variant→imagen,
...
async function handleClubWashAdd(request, env) {
  ...
  // Índice auxiliar para resolver DELETE /api/club/wash/:wash_id sin escanear todo el namespace
...
// ── Bloque B parte 3B, Fase 2: POST /api/club/post ──────────────────
...
// Índice de posts por customer, análogo a customer_<id>_pieces_index.
// No estaba explícito en el encargo pero es necesario para el pending
// check (Fase 2, validación 3) y para latest_reply (Fase 5.1) sin
...
// ── Fase 9.1: índice global posts_pending_all = { pending: [post_ids] } ──
...
// y handleClubPostRetract (remove) — cero cambio de comportamiento externo.
...
async function handleClubPost(request, env) {
  ...
  // Fase 9.1: índice global para queries admin O(1), sin tocar comportamiento externo
  ...
  // 12. Notificación Resend a thepost@potisse.com (best-effort, no falla el request)
  try {
    ...
    const res = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        text: `${captionPreview}\n\nView: https://potisse-shop.myshopify.com/admin/workshop-tools#post-curation\n\n— POTISSE system`
      })
    });
    if (!res.ok) {
...
// ── Bloque B parte 3B, Fase 3: POST /api/club/post/retract ──────────
...
async function handleClubPostRetract(request, env) {
  ...
  // 1. Rate limit 3 retracts/24h — al superarlo, flag para alerta Workshop Tools
  ...
  // Fase 9.1: sale del índice global de pending
  await removeFromPostsPendingAllIndex(env, post_id);

  // 7. contador histórico — nunca se resetea
  ...
  // 9. NO se borra R2 todavía — se indexa para el purge cron (Fase 6), que lo
  // borrará 24h después. Índice según spec Fase 6: retracted_posts = { pending: [post_ids] }.
...
// ── Bloque B parte 2, sección 7: aviso a Fran de orden pendiente de programar NFC ──
async function notifyFranPendingNfc(env, order) {
  ...
  const productSummary = (order.line_items || [])
    .map((li) => `${li.quantity}× ${li.name || li.title || li.sku}`)
    .join(", ");

  const body = {
    from: "club@potisse.com",
    to: "backend@potisse.com",
    subject: `Pending NFC — order ${orderName}`,
...
// ── Bloque B parte 2, sección 3: POST /api/admin/nfc-card ──
function isValidNfcUidHex(uid) {
  return typeof uid === "string" && /^[0-9A-F]{14}$/.test(uid);
}
...
// ── Bloque B parte 3A, sección 1.1: GET /api/admin/emergency-session ──
// Backdoor de acceso Club para Fran, sin depender de un tap NFC físico.
// v6.7: hotfix seguridad — este endpoint emitía sesiones sin comprobar
// ADMIN_KEY (agujero preexistente, no regresión de este push). Cualquiera
// con un customer_id numérico podía generar una sesión de Club válida.
...
// ── Bloque B parte 3B, Fase 4: POST /api/admin/post/curate ──────────
...
async function handleAdminPostCurate(request, env, url) {
  ...
  // 4. publish_ig requiere ig_post_url válida
  ...
  // 10. persistir (11: R2 nunca se toca aquí)
  await env.POTISSE_NFC.put(`post_${post_id}`, JSON.stringify(post));

  // Fase 9.1: sale del índice global de pending
  await removeFromPostsPendingAllIndex(env, post_id);

  // 12. invalidar cache del customer dueño del post
...
// ── Bloque B parte 3B, Fase 9.1: GET /api/admin/posts/pending ──────
async function handleAdminPostsPending(request, env, url) {
  ...
  for (const postId of index.pending || []) {
    ...
    if (post.status !== "pending") continue; // índice podría estar stale, defensivo
...
// ── Bloque B parte 3B, Fase 9.1: GET /api/admin/posts/retracted ────
// NOTA: el encargo original nombra el índice "retracted_posts_pending_purge",
// pero el índice real creado en Fase 3/6 es "retracted_posts" — verificado
// en el propio código (handleClubPostRetract + runPurgeRetracts). Uso el
// nombre real.
async function handleAdminPostsRetracted(request, env, url) {
  ...
  for (const postId of index.pending || []) {
    ...
    if (hoursSince >= 24) continue; // ya debería haber sido purgado por el cron
...
// ── Bloque B parte 3B, Fase 9.1: GET /api/admin/access-alerts ──────
async function handleAdminAccessAlertsGet(request, env, url) {
  ...
  return new Response(JSON.stringify({
    ok: true,
    iberian: alerts.iberian || [],
    european: alerts.european || [],
...
// ── Bloque B parte 3B, Fase 9.1: POST /api/admin/access-alerts/resolve ──
// NOTA: action="issue_detected" según el encargo debería "mover a Incidences",
// pero el sistema de Incidences (Fase 9.6.4) todavía no existe. Por ahora
// solo retira la alerta de access_alerts_active y lo deja logueado — la
// integración real con Incidences queda pendiente para cuando se construya.
const ACCESS_ALERT_RESOLVE_ACTIONS = ["verbal_confirmation", "issue_detected", "magic_link_sent", "contact_attempted"];
...
async function handleAdminAccessAlertResolve(request, env, url) {
  ...
  if (!order_id || !ACCESS_ALERT_RESOLVE_ACTIONS.includes(action)) {
    return new Response(JSON.stringify({ error: "invalid_body" }), {
      status: 400,
      headers: { "Content-Type": "application/json" }
    });
  ...
  const shouldRemove = action === "verbal_confirmation" || action === "issue_detected";
  let removed = false;
  let matchedEntry = null;

  ["iberian", "european"].forEach((zone) => {
  ...
  if (customerId) {
    ...
    log.push({ order_id, action, timestamp: new Date().toISOString() });
...
// ══════════════════════════════════════════════════════════════════
// Bloque B parte 3B, Fase 9.2 — Workshop Tools backend ampliado
// ══════════════════════════════════════════════════════════════════

// ── 9.2.1: GET /api/admin/posts/image/:post_id (R2 proxy) ──────────
...
// ── Fase 9.2: log de tap history NFC (uid_<uid>_tap_history) ───────
...
// ── 9.2.2: GET /api/admin/uid-info?uid=X (test tarjeta) ────────────
async function handleAdminUidInfo(request, env, url) {
  ...
  // Sin índice uid→sesión; escaneamos session_ activas (volumen bajo, TTL 30min)
...
// ── 9.2.3: POST /api/admin/email-customer ──────────────────────────
// ══════════════════════════════════════════════════════════════════
// EMAIL TEMPLATES — 15 templates, 2 variantes editoriales (Push 4a Mejora 6)
// ══════════════════════════════════════════════════════════════════

const EMAIL_TEMPLATES_REGISTRY = {
  size_color: {
    category: "Preventa / Información",
    variant: "A",
            ...
            <tr>
              <td style="padding: 0 45px;">
                ...
                <div style="margin-top: 55px; padding-top: 28px; border-top: 1px solid rgba(58, 50, 46, 0.08);">
                  ...
                  <p style="font-size: 13px; color: #3A322E; opacity: 0.7; margin: 0;">We're here — <a href="mailto:hola@potisse.com" style="color: #3A322E; text-decoration: none;">hola@potisse.com</a></p>
                  <p style="font-size: 11px; color: #3A322E; opacity: 0.35; margin: 16px 0 0 0;">${escapeHtml(signature)} · ${year}</p>
                </div>
              </td>
            </tr>
          </table>
...
const EMAIL_CUSTOMER_TEMPLATES = {
  ...
  size_color: (detail) => `*Quick question about your order — ${detail || "a detail"}. Reply when you can.*`
};
...
async function handleAdminEmailCustomer(request, env, url) {
  ...
  // ── Nuevo sistema de templates (15 templates) ──
  ...
  // ── Backward compatibility: 3 templates antiguos ──
  ...
  // ── Fallback total: custom libre sin template ──
  else {
    if (!custom_message) {
...
// ── 9.2.4/9.2.5/9.2.6: Members profile (list / detail / edit) ──────
...
async function handleAdminCustomersList(request, env, url) {
  ...
  for (const profile of profiles) {
    ...
    // Fase 9.2, Corrección 2: tags cacheadas 24h (evita N+1 real por fila,
    // ver hallazgo del testing anterior — 19s con 8 customers sin cache)
...
async function handleAdminCustomerDetail(request, env, url, customerIdParam) {
  ...
  // Tap history: uid_<uid> guarda customer_id pero no hay índice inverso
  // customer→uid, así que escaneamos uid_ (volumen bajo pre-launch).
...
// ═════════════════════════════════════════════════════════════════
// B.2 — Address sync with Shopify + post-write verification
// Si Shopify no persiste la dirección, propagamos el fallo
// honestamente al frontend SIN tocar KV.
// ═════════════════════════════════════════════════════════════════
// B.2 — Helper: equivalencia ISO↔nombre de país para verificación post-write
...
// ═══════════════════════════════════════════════════════════════════════
// SYNC STATUS & RETRY — Address sync visibility + manual retry
// ═══════════════════════════════════════════════════════════════════════
// ═══════════════════════════════════════════════════════════════════════
// B.2 — Webhook Shopify customers/update → KV
// Cuando un cliente edita sus datos en Shopify, actualizamos KV.
// ═══════════════════════════════════════════════════════════════════════
async function handleWebhookCustomersUpdate(request, env) {
  ...
  if (!customer.id) {
    await writeTimelineEvent(env, {
      ...
      severity: "warning",
      actor: "shopify",
      title: "Webhook customers/update ignored — no customer.id",
  ...
  if (typeof customer.email !== "string" && customer.email !== null) {
    await writeTimelineEvent(env, {
      ...
      severity: "warning",
      actor: "shopify",
      title: "Webhook customers/update ignored — invalid payload structure",
...
// v6.9.2 — GET /api/admin/members/:id/refresh-from-shopify
...
// ═════════════════════════════════════════════════════════════════
// v6.9.2 — POST /api/admin/members/:id/apply-shopify-refresh
// Escribe en KV tras confirmación explícita del operador.
// ═════════════════════════════════════════════════════════════════
...
// v6.7-members-admin — Fase 9.4.3 Oleada 1, backend Members
// ══════════════════════════════════════════════════════════════════
// Nota de campos pendientes (decisión Fran, empty-state + push futuro):
...
//   emisión de sesión en /api/validate.
// - Filtro quiet_list: array vacío. Los signups de Quiet List son
//   customers de Shopify (tag *-pending vía /api/subscribe) sin
//   customer_<id>_profile en KV — invisibles para cualquier endpoint que
...
// señales reales ya existentes: nº de pedidos (customer:<id>.orders) y nº
...
// ═══════════════════════════════════════════════════════════════════════
// QUIET LIST — Dedicated endpoint with stats
// ═══════════════════════════════════════════════════════════════════════
...
async function handleAdminMembersList(request, env, url) {
  ...
  for (const profile of profiles) {
    ...
    if (filter !== "all" && filter !== memberState) continue;
  ...
  return new Response(JSON.stringify({ ok: true, count: matched.length, customers: page, cursor: nextCursor }), {
    status: 200,
    headers: { "Content-Type": "application/json" }
  });
}
...
async function handleAdminMembersProfile(request, env, url, customerIdParam) {
  ...
  // Backfill lazy de first_seen_at (decisión Fran, Oleada 1)
  ...
  // dos puntos — key real del webhook Silencio 1, distinta de la key con
...
async function handleAdminMembersTags(request, env, url, customerIdParam) {
  ...
  // v6.7.1: envio_cortesia_activo es semánticamente un evento editorial
  // (Silencio 1 manual), no un tag genérico — Timeline lo distingue.
...
// ── 9.2.7/9.2.8/9.2.9: Stock (packaging + garments + production) ──
...
// ── 9.2.10/9.2.11: Salud del sistema + timeline ────────────────────
...
// lookup). Se devuelven como null con "data_gaps" explícito en vez de
// inventar números — ver reporte Fase 9.2.
// ── Fase 9.2, Corrección 3: integraciones externas para health/summary ──
...
// NOTA: mapeo de campos best-effort según formato JSON:API documentado por
// Better Stack — no verificado contra un payload real (no hay forma de
// probarlo sin el token real corriendo en producción). Si los nombres de
// campo no coinciden, esta función lanza y health/summary lo refleja en
// data_gaps sin romper el resto del endpoint.
// ── Fase 9.2, security patch v6.6.1: redacta query params sensibles ──
// Incidente: un monitor Better Stack tenía la ADMIN_KEY embebida en su URL
// configurada, y health/summary la reflejaba tal cual. Key ya rotada,
// monitor comprometido eliminado. Esta función es defensa en profundidad
...
async function fetchBetterStackMonitors(env) {
  ...
  return (data.data || []).map((m) => {
    ...
    return {
      // "name" también puede filtrar la URL cruda si falta pronounceable_name
      // (fallback previo era m.attributes?.url sin redactar) — usamos la
      // versión ya saneada aquí también.
...
// NOTA: mismo caveat que Better Stack — endpoint y schema según lo
...
// ── Fase 9.2: Telegram — forward-compat para Fase 9.8 ──────────────
// TELEGRAM_BOT_TOKEN/TELEGRAM_CHAT_ID todavía no existen como secrets
// (Fase 9.8 pendiente). Sin ellos, esta función no-opea con un warning en
// log en vez de fallar — mismo patrón defensivo que el resto de integraciones.
async function sendTelegramAlert(env, title, message, severity) {
  if (!env.TELEGRAM_BOT_TOKEN || !env.TELEGRAM_CHAT_ID) {
    console.warn("sendTelegramAlert: TELEGRAM_BOT_TOKEN/TELEGRAM_CHAT_ID no configurados todavía (Fase 9.8 pendiente)");
    return false;
  }
  const text = `⚠️ POTISSE Alert — ${severity}\n${title}\n\n${message}\n\n${new Date().toISOString()}`;
  try {
...
async function handleAdminHealthSummary(request, env, url) {
  ...
  try {
    ...
    dataGaps.push(`worker/kv/r2 analytics: Cloudflare Analytics API falló — ${err.message}`);
  }
  ...
  try {
    ...
    dataGaps.push(`better_stack.monitors: API falló — ${err.message}`);
  }
  ...
  try {
    ...
    dataGaps.push(`resend.delivery_rate_24h: API falló — ${err.message}`);
  }
  ...
  if (domainSsl) {
    ...
    if (domainDays != null && domainDays < 30) {
      await sendTelegramAlert(env, "Dominio próximo a expirar", `potisse.com expira en ${domainDays} días.`, "amber");
    }
    if (sslDays != null && sslDays < 30) {
      await sendTelegramAlert(env, "Certificado SSL próximo a expirar", `Certificado de potisse.com expira en ${sslDays} días.`, "amber");
    }
  } else {
    dataGaps.push("domain_expires / ssl_cert_expires: pendiente de introducir manualmente vía POST /api/admin/system/domain-ssl (una vez al año)");
  }

  dataGaps.push("worker.uptime_hours_since_deploy: no observable desde dentro del Worker, requiere log de deploy externo");
  dataGaps.push("kv.storage_mb: no incluido en las queries de Corrección 3 (kvOperationsAdaptiveGroups no reporta tamaño de storage)");
  dataGaps.push("shopify_tokens: requiere fechas de expiración reales, no integrado");
  dataGaps.push("rate_limits_triggered_24h: no hay contador persistente todavía (los rate limiters actuales son en memoria)");
...
// ── Fase 9.2, Corrección 3.4: POST /api/admin/system/domain-ssl ────
...
// original (key única timeline_events, nunca invocado en producción) por
// keys individuales timeline_<YYYYMMDD>_<epoch_ms>_<random>, shape rico y
// retención 90 días. Ver scripts/backfill_timeline.mjs para la migración
// del array legacy.
...
async function writeTimelineEvent(env, event) {
  ...
  const fullEvent = {
    ...
    // distinto de title (texto humano). Estaba en el diseño original de
    // Paso 4 y se cayó de la recapitulación de la decisión confirmada —
    // lo restauro porque los eventos concretos pedidos (customer_edited,
    // tag_added, etc.) no tienen dónde vivir sin él.
...
// Volumen bajo pre-launch (mismo patrón que listAllKeysWithPrefix en otros
...
// ── 9.2.12/9.2.13: Checklist pedido ─────────────────────────────────
// NOTA: el encargo mostraba solo 4 pasos explícitos seguidos de "..."
// (verify_data, email_customer_if_doubts, customer_data_kv, nfc_programmed).
// Uso esos 4 como default — la lista completa de pasos del protocolo real
...
async function handleAdminChecklistStep(request, env, url, orderId) {
  ...
  // "Ningún paso se puede saltar sin confirmar el anterior"
...
async function handleAdminMemberIncidencesPost(request, env, url, customerIdParam) {
  ...
  const validTypes = ["defect", "delay", "lost", "return", "other", "complaint", "silencio"];
  ...
  // Push 5.5: alerta email para incidencias críticas
...
<div style="max-width:480px;margin:0 auto;border-left:2px solid #B8863D;padding-left:24px;">
  ...
  <p style="font-size:11px;opacity:0.4;margin:0;">— POTISSE System · ${new Date().toISOString()}</p>
</div>
</body></html>`,
...
// ── Incidences stats (sidebar badge) ───────────────────────────────
async function handleAdminIncidencesStats(request, env, url) {
  ...
  return new Response(JSON.stringify({ ok: true, open, critical }), {
    status: 200, headers: { "Content-Type": "application/json" }
  });
}
__name(handleAdminIncidencesStats, "handleAdminIncidencesStats");

// ── Incidences (global list) ────────────────────────────────────────
...
var worker_default = {
  async fetch(request, env, ctx) {
    ...
    // ═════════════════════════════════════════════════════════════════
    // v6.9.0 — Global TOTP middleware for POST/PUT /api/admin/*
    // ═════════════════════════════════════════════════════════════════
    ...
    if (url.pathname === "/api/webhook/orders-create" && request.method === "POST") {
      ...
      // SILENCIO 1 Ã¢â‚¬â€ Actualizar/crear objeto customer:{id} en KV
      // Ã¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢ÂÃ¢â€¢Â
      try {
        await updateCustomerKvForSilencio1(env, order);
      } catch (err) {
        // Log pero NO fallar el webhook. Metafields ya se procesaron.
        console.error("Silencio1 KV update failed:", err.message);
      }
      let piecesResult = { created: false, isMember: false };
      try {
        piecesResult = await createPiecesForOrder(env, order);
      } catch (err) {
        console.error("Pieces creation failed:", err.message);
      }
      // Bloque B parte 2, sección 7: solo avisar a Fran si se crearon piezas
      ...
      if (piecesResult.created && !piecesResult.isMember) {
        try {
          ...
          console.error("Resend NFC notification failed:", err.message);
        }
      }
      return new Response("OK", { status: 200 });
    }
    if (url.pathname === "/api/webhook/orders-fulfilled" && request.method === "POST") {
      ...
      try {
        ...
        console.error("Silencio1 fulfilled handler failed:", err.message);
      }
      try {
        await updatePiecesForFulfillment(env, order);
      } catch (err) {
        console.error("Pieces fulfillment update failed:", err.message);
      }
      return new Response("OK", { status: 200 });
    }
    if (url.pathname === "/api/webhook/refunds-create" && request.method === "POST") {
      ...
      try {
        ...
        console.error("Silencio1 refund handler failed:", err.message);
      }
      return new Response("OK", { status: 200 });
    }
    if (url.pathname === "/api/webhook/customers-update" && request.method === "POST") {
      return handleWebhookCustomersUpdate(request, env);
    }
    ...
    if (url.pathname === "/api/validate") {
      ...
      if (nfcParam === "valid" && uidParam && ctrParam && cmacParam) {
        try {
          ...
          if (result.valid) {
            ...
            // ── Bloque B parte 2, sección 2: activación Club end-to-end ──
            const uid = uidParam;

            // PASO A — resolver order_id / customer_id / email desde uid_<uid>
            const uidDataRaw = await env.POTISSE_NFC.get(`uid_${uid}`);
            const uidObj = uidDataRaw ? JSON.parse(uidDataRaw) : null;
            if (!uidDataRaw) {
              console.warn(`Club activation: no uid_${uid} record — legacy tap, cookie sin activación de piezas`);
            }
            ...
            // PASO B — determinar primera vez (para el redirect)
            let firstTime = true;
            ...
            if (hasOrder) {
              ...
              if (!orderIndexRaw) {
                firstTime = true;
                console.warn(`Club activation: order_${orderId}_pieces_index no existe todavía (webhook orders/create pendiente), firstTime=true por defecto`);
              } else {
            ...
            // PASO C — activación de piezas (idempotente por pieza), silenciosa ante fallos
            ...
            // PASO E — redirect con Set-Cookie
            let redirectUrl;
            if (firstTime) {
            ...
            // Fase 9.2: log tap history (éxito)
            ...
            // Fase 9.2: log tap history (CMAC inválido)
      ...
      if (tokenParam) {
        ...
        // Magic Link v2: si tiene customer_id, emitir sesión Club directa
    ...
    // ── Fase 9.2: Workshop Tools backend ampliado ──────────────────
    ...
    // v6.9.2 — Refresh from Shopify (READ-ONLY diff)
    ...
    const refreshFromShopifyAlias = url.pathname.match(/^\/api\/admin\/customer\/([^/]+)\/refresh-from-shopify$/);
    if (refreshFromShopifyAlias && request.method === "GET") {
      return handleAdminMembersRefreshFromShopify(request, env, url, refreshFromShopifyAlias[1]);
    }
    // v6.9.2 — Apply Shopify refresh (writes KV after confirmation)
    ...
    const applyShopifyRefreshAlias = url.pathname.match(/^\/api\/admin\/customer\/([^/]+)\/apply-shopify-refresh$/);
    if (applyShopifyRefreshAlias && request.method === "POST") {
      return handleAdminMembersApplyShopifyRefresh(request, env, url, applyShopifyRefreshAlias[1]);
    }
    const customerEditMatch = url.pathname.match(/^\/api\/admin\/customer\/([^/]+)\/edit$/);
    if (customerEditMatch && request.method === "POST") {
      const res = await handleAdminCustomerEdit(request, env, url, customerEditMatch[1], ctx);
      return res;
    }
    ...
    const customerDetailMatch = url.pathname.match(/^\/api\/admin\/customer\/([^/]+)$/);
    if (customerDetailMatch && request.method === "GET") {
      return handleAdminCustomerDetail(request, env, url, customerDetailMatch[1]);
    }// ── v6.7-members-admin: Fase 9.4.3 Oleada 1 ──
    ...
    // /api/customer-update Ã¢â‚¬â€ Identity edit from /pages/you (HMAC-signed)
    if (url.pathname === "/api/customer-update") {
      if (request.method !== "POST") {
        return jsonResponseYou({ ok: false, error: "Method not allowed" }, 405);
      }
  ...
  if (!adminKeyHeader && adminKey) {
    ...
    await writeTimelineEvent(env, { type: "legacy_admin_key", severity: "info", endpoint: request.url, timestamp: new Date().toISOString() });
  };
...
// DIAGNÓSTICO: si llegamos aquí, ninguna ruta coincidió
  ...
  async scheduled(event, env, ctx) {
    ...
    ctx.waitUntil((async () => {
      try {
        if (event.cron === "0 3 * * *") {
          // v6.6.2: timestamp "el cron corrió" escrito ANTES de la evaluación,
          // no después — endurecimiento defensivo (evaluateSilencio1Candidates
          // no tiene early return hoy, pero así queda blindado si algún día lo tiene).
